...
function Register() {
    ...
    const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (result.success) {
            ...
            toast.current?.show({ severity: 'success', summary: 'Success', detail: "Conta criada com sucesso!", life: 3000 });
        ...
        <>
            ...
            <div className="mx-auto flex h-screen max-w-lg flex-col md:max-w-none md:flex-row md:pr-10 bg-gray-800">
                ...
                <div className="px-4 py-20">
                    ...
                    <p className="mb-1 font-medium text-white">Escolha o seu plano</p>
                    <div className="mb-6 flex flex-col gap-y-2 gap-x-4 lg:flex-row">
                        <div className="relative flex w-56 items-center justify-center rounded-xl bg-gray-50 px-4 py-3 font-medium text-gray-700">
                            ...
                            <span className="pointer-events-none z-10">Básico</span>
                        </div>
                        <div className="relative flex w-56 items-center justify-center rounded-xl bg-gray-50 px-4 py-3 font-medium text-gray-700">
                            <input className="peer hidden" type="radio" name="radio" id="radio2" checked />
                            <label className="peer-checked:border-blue-600 peer-checked:bg-blue-200 absolute top-0 h-full w-full cursor-pointer rounded-xl border" for="radio2"> </label>
                            <div className="peer-checked:border-transparent peer-checked:bg-blue-600 peer-checked:ring-2 absolute left-4 h-5 w-5 rounded-full border-2 border-gray-300 bg-gray-200 ring-blue-600 ring-offset-2"></div>
                            <span className="pointer-events-none z-10">Premium</span>
                        </div>
                        <div className="relative flex w-56 items-center justify-center rounded-xl bg-gray-50 px-4 py-3 font-medium text-gray-700">
                            ...
                            <div className="peer-checked:border-transparent peer-checked:bg-blue-600 peer-checked:ring-2 absolute left-4 h-5 w-5 rounded-full border-2 border-gray-300 bg-gray-200 ring-blue-600 ring-offset-2"></div>
                            <span className="pointer-events-none z-10">Empresa</span>
                        </div>
                    </div>
